...
///--------------------------------------------------
    ...
    RV32_SSP.DECODE.RF.REG[2]  = 20;
    RV32_SSP.DECODE.RF.REG[3]  = 30;
    RV32_SSP.DECODE.RF.REG[4]  = 40;
    
    RV32_SSP.DECODE.RF.REG[5]  = 100;    // load base
    RV32_SSP.DECODE.RF.REG[6]  = 60;
    RV32_SSP.DECODE.RF.REG[7]  = 70;
    
    //--------------------------------------------------
    // DMEM
    //--------------------------------------------------
    
    RV32_SSP.MEM_STAGE_B.dmem.MEM[100] = 32'h12345678;
    ...
    // inst1 writes x10
    //
    // Final x10 must come from inst1
    //==================================================
    
    RV32_SSP.FETCH.IMEM.MEM[0] =
    {12'd5,x1,F3_ADD_SUB,x10,OP_IMM};     // x10 = 15
    
    RV32_SSP.FETCH.IMEM.MEM[1] =
    {12'd9,x2,F3_ADD_SUB,x10,OP_IMM};     // x10 = 29
    
    
    //==================================================
    // WAW TEST-2
    //
    // inst2 writes x11 from LOAD
    // inst3 writes x11 from ALU
    //
    // Load is older
    // ALU is younger
    //
    // Final x11 must come from ALU
    //==================================================
    
    RV32_SSP.FETCH.IMEM.MEM[2] =
    {12'd0,x5,F3_LW,x11,LOAD};            // x11 = 0x12345678
    
    RV32_SSP.FETCH.IMEM.MEM[3] =
    {12'd7,x6,F3_ADD_SUB,x11,OP_IMM};     // x11 = 67
