...
RV32_SSP.FETCH.IMEM.MEM[6] <= {F7_ADD,x6,x1,F3_ADD_SUB,x5,OP};
...
RV32_SSP.FETCH.IMEM.MEM[11] <= {F7_ADD,x8,x2,F3_ADD_SUB,x7,OP};
...
RV32_SSP.FETCH.IMEM.MEM[14] <= {F7_ADD,x10,x3,F3_ADD_SUB,x9,OP};
...
RV32_SSP.FETCH.IMEM.MEM[16] <= {F7_ADD,x12,x4,F3_ADD_SUB,x11,OP};
